...
#define output_REG_OFFSET (0x00)
#define output_ID_OFFSET  (0x02)

/* platform device */
struct plat_output_port{
	...
	struct output_dev *sdev;	/* struct for main device structure*/
};
